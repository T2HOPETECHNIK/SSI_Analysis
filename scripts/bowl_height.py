...
input_csv_path = '../data/raw/bowl_hand_2.csv'  # Replace with your input CSV file path
...
output_csv_path = '../data/processed/bowl_height_result.csv'  # Replace with your output CSV file path
